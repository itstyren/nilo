...
class MlpExtractor(nn.Module):
    ...
    def __init__(
        ...
        last_layer_dim_pi = feature_dim[0] if isinstance(feature_dim, list) else feature_dim
        last_layer_dim_vf = feature_dim[1] if isinstance(feature_dim, list) else feature_dim
